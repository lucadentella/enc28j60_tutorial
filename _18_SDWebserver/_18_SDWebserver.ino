...
void loop() {
  ...
  if(pos) {
    ...
    // if the request is for a "dynamic page, do the magic (send the millis() value)
    else if(strncmp("GET /uptime.ino ", request, 16) == 0) {
      
      Serial.print(F("Requested dynamic page: uptime.ino"));
